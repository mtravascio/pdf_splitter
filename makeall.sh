...
cp ../../assets/64.png bundle/net.regeomaria.pdf_splitter.png
cp ../../assets/pdf_splitter.desktop bundle/net.regeomaria.pdf_splitter.desktop
...
flatpak install --reinstall pdf_splitter.flatpak #Installa il pacchetto flatpak appena creato
